...
from whiteprints import metadata
...
class TestVersion:
    ...
    def test___version___respects_pep_440() -> None:
        ...
        Version numbers must respect PEP440
        """
        version_number = metadata.extract_field("Version")
        assert version_number is not None, "Version number should be a string"
...
class TestLicense:
    ...
    @staticmethod
    def test_license_expression() -> None:
        """Test if a license metadata exists."""
        assert metadata.extract_field("License-Expression"), (
    ...
    def test_license_file() -> None:
        ...
        assert metadata.extract_fields("License-File"), (
